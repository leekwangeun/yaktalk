...
# 약 이름 후보에서 제외할 일상어.
# 제품명 4.3만 개 중에는 일상어와 겹치거나 한 글자만 다른 이름이 많아
# ("오늘"→오늘비타더블골드, "정보"→정보에스, "사람"→사람단백질씨),
# 거르지 않으면 평범한 문장에서 엉뚱한 약이 잡힌다.
STOPWORDS = frozenset({
    # 병용 질문 표현
    "같이", "함께", "동시에", "먹어도", "먹으면", "복용", "복용해도", "돼",
    "되나", "괜찮아", "괜찮나", "괜찮을까", "있어", "알려줘", "그리고",
    # 대상·상태 (복용 조건으로 따로 받는 값)
    "임신", "임신중", "임산부", "수유", "수유중", "아이", "애기", "어린이",
    "노인", "어르신", "엄마", "아빠", "할머니", "할아버지",
    # 질문 유형 신호어
    "부작용", "추천", "영양제", "성분",
    "무슨", "무엇", "뭐", "뭐뭐", "어떤", "어느", "이런", "그런", "저런",
    "이거", "그거", "저거", "만든", "만들",
    # 시간 표현
    "지금", "오늘", "내일", "어제", "요즘", "매일", "주말", "이번", "다음", "저번",
    "아까", "방금", "나중", "이따", "새벽", "오전", "오후", "아침", "점심", "저녁", "하루",
    # 인사·대화
    "안녕", "안녕하세요", "감사", "고마워", "미안", "죄송", "반가워",
    # 몸 상태·증상 (약 이름이 아니라 증상 서술)
    "머리", "배가", "속이", "몸이", "기분", "컨디션", "피곤", "졸려", "아파", "아픈",
    "감기", "몸살", "두통", "복통", "설사", "변비", "기침",
    # 일반 명사
    "날씨", "회사", "학교", "친구", "가족", "병원", "약국", "의사", "약사",
    "음식", "식사", "생각", "질문", "정보", "사람", "시간", "문제", "방법",
    "이유", "결과", "상태", "종류", "가격",
    # 부사·감탄사
    "그냥", "혹시", "아마", "정말", "진짜", "너무", "조금", "많이", "제일", "가장",
})
